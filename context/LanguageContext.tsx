...
const translations = {
  es: {
    ...
    'banner.urgency': 'Capacidad limitada: 5 proyectos mensuales. Reserva hoy tu auditoría de diagnóstico para asegurar tu cupo de Mayo.',
    ...
    'contact.whatsapp.msg': 'Hola, quiero agendar un diagnóstico gratuito.',
  ...
  en: {
    ...
    'banner.urgency': 'Limited capacity: 5 projects per month. Book your diagnostic audit today to secure your spot for May.',
    ...
    'contact.whatsapp.msg': 'Hi, I want to schedule a free diagnosis.',
