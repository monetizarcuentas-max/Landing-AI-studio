...
const steps = [
  {
    ...
    icon: (
      <div className="relative w-24 h-48 bg-dark/90 rounded-[2rem] border-4 border-gray-800 flex flex-col items-center p-2 shadow-[0_0_30px_rgba(59,130,246,0.2)]">
  ...
  },
  {
    ...
    subtitle: 'CAPTACIÓN',
    icon: (
      <div className="relative w-40 h-32 bg-dark/90 rounded-xl border border-indigo-500/40 flex flex-col p-2.5 shadow-[0_0_30px_rgba(99,102,241,0.2)]">
  ...
  },
  {
    ...
    icon: (
      <div className="relative w-24 h-48 bg-dark/90 rounded-[2rem] border-4 border-gray-800 flex flex-col p-2 shadow-[0_0_30px_rgba(34,197,94,0.2)]">
...
const WorkflowAnimation: React.FC = () => {
  return (
    <div className="relative w-full max-w-6xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-4 lg:gap-6 py-10">
      {/* Background Network */}
      ...
      {steps.map((step, i) => (
        <React.Fragment key={step.id}>
          <motion.div
            className="flex flex-col items-center z-10 w-full max-w-[280px] lg:max-w-[220px] xl:max-w-[260px]"
          ...
          {i < steps.length - 1 && (
            <motion.div
              className="hidden lg:flex items-center justify-center text-accent/60 z-0"
          ...
          {i < steps.length - 1 && (
            <motion.div
              className="flex lg:hidden items-center justify-center text-accent/60 z-0 my-2"
              animate={getArrowAnimation(i)}
              transition={{ duration: T, repeat: Infinity, ease: "easeOut" }}
            >
